...
/**
 * Servlet handling input provided during letter delete operation
 * @author rkubas
 * @date 2017-11-25
 * @version 1.0
 */
public class DeletedLetterServlet extends HttpServlet {
     ...
     * methods. Handles corectness of the input.
     *
    ...
    private void handleEmptyInput(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        request.setAttribute("resultURL", "DeleteLetterPanelServlet");
    ...
    private void handleDatabaseProblem(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("resultMessage", "Db error or letter's id doesn't exist");
        request.setAttribute("resultURL", "DeleteLetterPanelServlet");
        request.getRequestDispatcher("ResultServlet").forward(request, response);
    }
